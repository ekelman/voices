<?php
	...
	*/
	...
	$xmlFileName 	= $_SERVER{'DOCUMENT_ROOT'} . "/statenet/"  . date('Ymd')."_US.xml";	
	...
	{
		$xmlFileName = $_SERVER{'DOCUMENT_ROOT'} . "/statenet/" . date('Ymd',   strToTime($day.' day'))."_US.xml";	
		$day--;
	}
	
	echo $xmlFileName;	
	$text = $xmlFileName;
	$result	=	SendMail($text, "Cron update bills", array("paras.shah@netsmartz.net"),$_CONF['adminEmail']);
