<?php /* Smarty version 2.6.10, created on 2014-03-09 22:57:20
         compiled from electedrepresentative/ihtml/search_fields.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'electedrepresentative/ihtml/search_fields.html', 7, false),)), $this); ?>
<?php echo '
...
">
			...
			<td width="25%"><select name="search_field" id="search_field"  style="width:165px;">
					...
					<option value="mname" <?php if ($this->_tpl_vars['search_field'] == mname): ?>selected<?php endif; ?>>Middle Name</option>
...
">
		...
		<input type='hidden' name='mode'  value='ListElectedrepresentative'/>
		</td></tr>
	</tbody>
	</form>
</table>
