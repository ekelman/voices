<?php /* Smarty version 2.6.10, created on 2012-12-17 08:58:15
         compiled from affiliates/ihtml/vote_alerts.html */ ?>
<?php echo '
<script>
...
<tr>
	...
	<tr>
		...
		<tr>
			...
			<table width="100%" cellspacing="0" cellpadding="0" border="0">
			<tr>
				<td width="34%" valign="middle" style="padding-left: 14px;" class="topsublink_bg arial_15_000_bold">Bills</td>
				...
				<tr>
					...
					<tr>
						...
						<tr>
							...
							<a href="index.php?stage=affiliates&mode=VoteAlertsDetail&id=<?php echo $this->_tpl_vars['affiliateVoteAlert'][$this->_sections['i']['index']]['article_id']; ?>
...
')"
							...
							<!-- <a href="#">
							<img src="images/btn_new.gif" alt="" width="24" height="14" border="0" />
							</a> -->
							</td>
						</tr>
						<tr>
						...
						<td align="left" valign="top"
							...
							<table width="100%">
								<tr>
									<td valign="top"
										class="bg_f7f6ee"
										align="center">There are no alerts.</td>
								</tr>
							</table></td>
					</tr>
				<?php endif; ?>																
