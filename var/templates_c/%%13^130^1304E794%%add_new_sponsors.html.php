<?php /* Smarty version 2.6.10, created on 2013-01-28 09:18:38
         compiled from affiliates/ihtml/add_new_sponsors.html */ ?>
<?php echo '
																		...
																		<table width="100%" cellspacing="0" cellpadding="0">
																			...
																			<tr>
																				<td colspan="3"><textarea
																						name="sponsor_description" class="borderBlack"  maxlength="100"
																						style="width: 99.5%; height: 90px;"></textarea>
																				</td>
																			</tr>
																			...
																			<tr>
																				<td valign="top"><input
																					class="borderBlack widthinput" type="text"
																					name="sponsor_url" id="sponsor_url" /></td>
																				<td height="30px">&nbsp;</td>
																				<td valign="top">&nbsp;</td>
																			</tr>
...
' />
																								...
																								<input type="hidden" name="mode" value='SaveNewSponsors' /> 
