<?php /* Smarty version 2.6.10, created on 2014-03-03 18:04:56
         compiled from accession/ihtml/manage_permissions.html */ ?>
<?php echo '
...
?>	
				...
				<tr>
					<td class="<?php if ($this->_sections['i']['iteration']%2 == 0): ?>heading<?php else: ?>odd<?php endif; ?>" style="width:auto">
						<b>			
...
?>						
							...
							<td class="<?php if ($this->_sections['i']['iteration']%2 == 0): ?>odd<?php else: ?>even<?php endif; ?> combo" style="width:auto;" 
