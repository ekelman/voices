<?php /* Smarty version 2.6.10, created on 2012-05-01 17:48:41
         compiled from electedrepresentative/ihtml/er_article.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'electedrepresentative/ihtml/er_article.html', 41, false),array('modifier', 'date_format', 'electedrepresentative/ihtml/er_article.html', 61, false),)), $this); ?>
												...
												<table width="100%" cellspacing="0" cellpadding="0" border="0">
													<tr>
														<td width="34%" valign="middle"
															...
															class="topsublink_bg arial_15_000_bold">My Articles</td>
																			...
																			<tr>
																				...
																				<td width="847" align="left" valign="top"
																					...
																					<table width="100%" border="0" cellspacing="0"
																						cellpadding="0">
																						<tr>
																							<td align="left" valign="top"><?php echo ((is_array($_tmp=$this->_tpl_vars['oArticle'][$this->_sections['i']['index']]->comment)) ? $this->_run_mod_handler('truncate', true, $_tmp, 140) : smarty_modifier_truncate($_tmp, 140)); ?>

																							&nbsp;&nbsp;
																							<?php if ($this->_tpl_vars['ERContentArticleModifyOwnContent']): ?>																	
																								<a href = "index.php?stage=electedrepresentative&mode=EditArticle&articleID=<?php echo $this->_tpl_vars['oArticle'][$this->_sections['i']['index']]->article_id; ?>
"
																							...
																							<?php if ($this->_tpl_vars['ERContentArticleDelete']): ?>																		
																								<a href = "index.php?stage=electedrepresentative&mode=DeleteArticle&articleID=<?php echo $this->_tpl_vars['oArticle'][$this->_sections['i']['index']]->article_id; ?>
"
																									z = "arial12Ba60000" onClick="if(!confirm('Are you sure to delete this article?')) return false;">
																						...
																						<tr>
																							...
																							<a href="index.php?stage=electedrepresentative&mode=ArticleDetail&id=<?php echo $this->_tpl_vars['oArticle'][$this->_sections['i']['index']]->article_id; ?>
"
