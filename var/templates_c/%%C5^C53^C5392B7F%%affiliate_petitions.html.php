<?php /* Smarty version 2.6.10, created on 2012-01-09 14:39:45
         compiled from subscriber/ihtml/affiliate_petitions.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'subscriber/ihtml/affiliate_petitions.html', 47, false),array('modifier', 'html_entity_decode', 'subscriber/ihtml/affiliate_petitions.html', 64, false),)), $this); ?>
												...
												<table width="100%" cellspacing="0" cellpadding="0"
													...
													<tr>
														<td width="34%" valign="middle"
															...
															class="topsublink_bg arial_15_000_bold">Petitions</td>
...
?>
																																<?php if (( $this->_tpl_vars['affiliatePetitions'][$this->_sections['i']['index']]['voting_end'] >= ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, '%Y-%m-%d') : smarty_modifier_date_format($_tmp, '%Y-%m-%d')) )): ?> 
																<tr>
...
&mode=affiliatePetitionsDetail&id=<?php echo $this->_tpl_vars['affiliatePetitions'][$this->_sections['i']['index']]['article_id']; ?>
"
																								  class="arialB13000000"> 
																										<?php echo ((is_array($_tmp=$this->_tpl_vars['affiliatePetitions'][$this->_sections['i']['index']]['article_title'])) ? $this->_run_mod_handler('html_entity_decode', true, $_tmp) : html_entity_decode($_tmp)); ?>
 </a> 
																								<!-- <a href="#"> <img src="images/btn_new.gif"
																										alt="" width="24" height="14" border="0" /> </a> -->
																							</td>
																						</tr>
																						<tr>
																							<td align="left" valign="top">
																								<?php echo ((is_array($_tmp=$this->_tpl_vars['affiliatePetitions'][$this->_sections['i']['index']]['affiliate_comment'])) ? $this->_run_mod_handler('html_entity_decode', true, $_tmp) : html_entity_decode($_tmp)); ?>
</td>
																						</tr>
																						<tr>
