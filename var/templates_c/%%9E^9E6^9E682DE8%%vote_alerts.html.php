<?php /* Smarty version 2.6.10, created on 2013-01-28 10:19:28
         compiled from subscriber/ihtml/vote_alerts.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'html_entity_decode', 'subscriber/ihtml/vote_alerts.html', 57, false),array('modifier', 'date_format', 'subscriber/ihtml/vote_alerts.html', 70, false),)), $this); ?>
<tr>
								...
								<tbody>
									<tr>
										...
										<?php if ($_SESSION['member_type'] == 'subscriber'): ?>													
											...
											<td width="106" align="right" valign="top"><a class="Activebutton" href="index.php?stage=subscriber&mode=VoteAlerts"><span>Vote Alerts</span></a></td>																		
...
" class="arialB13000000"><?php echo ((is_array($_tmp=$this->_tpl_vars['MyAffiliateArticles'][$this->_sections['i']['index']]['article_title'])) ? $this->_run_mod_handler('html_entity_decode', true, $_tmp) : html_entity_decode($_tmp)); ?>
</a>
										<?php if ($this->_tpl_vars['MyAffiliateArticles'][$this->_sections['i']['index']]['vote_status'] == 'NA'): ?>
											<a href="index.php?stage=subscriber&mode=VoteAlertsDetail&id=<?php echo $this->_tpl_vars['MyAffiliateArticles'][$this->_sections['i']['index']]['article_id']; ?>
">
											<img src="images/btn_new.gif" alt="" width="24" height="14" border="0" /></a>
										<?php endif; ?>										 
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<span class="arial12Ba60000" style="float: left">Dated:
											<span class="arial11Na60000"><?php echo ((is_array($_tmp=$this->_tpl_vars['MyAffiliateArticles'][$this->_sections['i']['index']]['created'])) ? $this->_run_mod_handler('date_format', true, $_tmp, '%Y-%m-%d') : smarty_modifier_date_format($_tmp, '%Y-%m-%d')); ?>
</span></span>
									<a href="index.php?stage=subscriber&mode=VoteAlertsDetail&id=<?php echo $this->_tpl_vars['MyAffiliateArticles'][$this->_sections['i']['index']]['article_id']; ?>
						...
						<tr>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<tr>
										<td height="22" align="left" valign="top">
										<a href="index.php?stage=subscriber&mode=petitionsDetail&affID=<?php echo $this->_tpl_vars['MyAffiliateArticles'][$this->_sections['i']['index']]['affiliate_id']; ?>
...
" class="arialB13000000">
									...
									<tr>
										<td height="26" align="right" valign="bottom">
										<span class="arial12Ba60000" style="float: left">Dated:&nbsp;<span class="arial11Na60000"><?php echo ((is_array($_tmp=$this->_tpl_vars['MyAffiliateArticles'][$this->_sections['i']['index']]['created'])) ? $this->_run_mod_handler('date_format', true, $_tmp, '%Y-%m-%d') : smarty_modifier_date_format($_tmp, '%Y-%m-%d')); ?>
</span></span>
										<a href="index.php?stage=subscriber&mode=petitionsDetail&affID=<?php echo $this->_tpl_vars['MyAffiliateArticles'][$this->_sections['i']['index']]['affiliate_id']; ?>
&id=<?php echo $this->_tpl_vars['MyAffiliateArticles'][$this->_sections['i']['index']]['article_id']; ?>
" class="arial12Ba60000">[read more]</a>
						...
						<?php endfor; else: ?>
						<tr>
							<td align="center" valign="top" class="bg_f7f6ee">No Alerts.</td>
						</tr>
						<?php endif; ?>
						</table>
						</td>
