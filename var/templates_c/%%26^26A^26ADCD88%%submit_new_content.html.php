<?php /* Smarty version 2.6.10, created on 2012-11-09 16:30:24
         compiled from electedrepresentative/ihtml/submit_new_content.html */ ?>
<?php echo '
				...
				<td valign="top" align="left" class="arial_16_c40306"><table width="100%" cellspacing="0" cellpadding="0" border="0">
				  <tbody><tr>
					...
					<table width="100%" cellspacing="0" cellpadding="0" border="0">
					  <tbody>
					  <tr>
						<td valign="bottom" align="left" height="37" style="padding-bottom: 5px;" class="Trebuchet_27_c60000" colspan="2">Submit New Article</td>
					  </tr>
					  <tr>
					  ...
					  <tr>
						...
						<tr>
							<td colspan="3"><textarea name="comment" class="borderBlack" style="width: 99.5%; height: 150px;"></textarea>
						</td>
						</tr>
						<tr>
							<td class="tdReqPadd20" colspan="3" align="center">
							<input type="hidden" name="stage" value='electedrepresentative' />
							<input type="hidden" name="mode" value='addnewcomment' />
...
<script language=\'javascript\' type=\'text/javascript\'>
	...
	frmvalidator.addValidation("comment","maxlen=200","Comment should not be more then 300 characters.");
</script>
'; ?>