<?php /* Smarty version 2.6.10, created on 2013-01-28 13:49:41
         compiled from subscriber/ihtml/affiliate_news.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'html_entity_decode', 'subscriber/ihtml/affiliate_news.html', 67, false),)), $this); ?>
																					...
																					<table width="100%" border="0" cellspacing="0"
																						...
																						<tr>
																							<td height="22" align="left" valign="top">
																								...
																								<a
																								href="index.php?stage=subscriber&mode=NewsDetail&affID=<?php echo $this->_tpl_vars['vAffiliate']->member_id; ?>
...
"
																...
																<?php endfor; else: ?>
																<tr>
																	<td align="center" valign="top" class="bg_f7f6ee">No News.</td>
																</tr>
																<?php endif; ?>
															</table>
														</td>
