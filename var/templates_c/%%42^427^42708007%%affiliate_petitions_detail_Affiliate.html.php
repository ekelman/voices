<?php /* Smarty version 2.6.10, created on 2012-07-30 16:56:17
         compiled from subscriber/ihtml/affiliate_petitions_detail_Affiliate.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'html_entity_decode', 'subscriber/ihtml/affiliate_petitions_detail_Affiliate.html', 53, false),array('modifier', 'date_format', 'subscriber/ihtml/affiliate_petitions_detail_Affiliate.html', 91, false),)), $this); ?>
		...
		<tr>
			...
			<tr>
				...
				<tr>
					...
					<a class="button" href="index.php?stage=subscriber&mode=AffiliateVoteAlerts&affID=<?php echo $this->_tpl_vars['vAffiliate']->member_id; ?>
"><span>Bills & Petitions</span></a>
					<?php if ($_SESSION['member_type'] == 'affiliate' && $this->_tpl_vars['ArticleAssociation'] == false): ?>
																		<a
																			class="button"
																			href="index.php?stage=affiliates&articleID=<?php echo $this->_tpl_vars['affiliatePetitions'][0]['article_id']; ?>
&article_type=<?php echo $this->_tpl_vars['affiliatePetitions'][0]['article_type']; ?>
&aff_id=<?php echo $this->_tpl_vars['affiliatePetitions'][0]['affiliate_id']; ?>
...
</span></span> <!--Changes by Monika Bansal on 24th July 2012-->
							<?php if ($_SESSION['member_type'] == 'subscriber'): ?>
							<?php if ($this->_tpl_vars['voting_details'] == 'support'): ?>
															You have signed this petition.									
							<?php else: ?>							
															<?php if ($this->_tpl_vars['affiliate_content_bills_vote_content']): ?>																			
