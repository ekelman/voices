<?php /* Smarty version 2.6.10, created on 2014-03-09 22:16:52
         compiled from user/ihtml/header.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'capitalize', 'user/ihtml/header.html', 5, false),)), $this); ?>
...
<script language=javascript src="scripts/googleautofill.js"></script>
                          ...
                          <tr>
                            <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                ...
                                <td align="left" valign="top" class="img_nav_rp" style="padding:0px 15px 0 15px;">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td width="85" height="28" align="center" valign="middle">
									<a href="/" class="Verdana_11_fff_bold">Home</a>
									</td>
                                    <td width="125" align="center" valign="middle" class="Verdana_11_fff_bold"><a href="index.php?stage=billresources&mode=billDetail" class="Verdana_11_fff_bold question">Bill Resources</a><img src="images/question_blue.png" class="icon-ques" style="cursor:pointer;" id='bill' title='Each time an Affiliate posts a comment on a Bill, we create a "Bill Resource
...
'/></td>
                                    <td width="102" align="center" valign="middle" class="Verdana_11_fff_bold"><a href="index.php?stage=affiliates&mode=listaffiliates" class="Verdana_11_fff_bold question">Affiliates</a><img src="images/question_blue.png"  class="icon-ques"style="cursor:pointer;" id='aff' title='Affiliates are organizations that advocate a position on issues that are important to
...
'/></td>
                                    <td width="175" align="center" valign="middle" class="Verdana_11_fff_bold"><a href="index.php?stage=electedrepresentative&mode=electedrepresentativelist" class="Verdana_11_fff_bold question">Elected Representatives</a><img class="icon-ques" src="images/question_blue.png" style="cursor:pointer;" id='elected' title='We provide you with a list of your elected representatives here,
...
.'/></td>							<td width="95" align="center" valign="middle" class="Verdana_11_fff_bold"><a href="index.php?stage=pages&mode=AboutUs" class="Verdana_11_fff_bold">About Us</a></td>
									...
									<a title="Logout" class="arial11NRC0DDEF" href="index.php?stage=member&amp;mode=memberLogout">
										<img src="images/btn_logout.gif" alt="" width="66" height="23" border="0" title="Logout" /></a>
									<?php else: ?>
