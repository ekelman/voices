<?php /* Smarty version 2.6.10, created on 2014-03-03 11:38:53
         compiled from affiliates/ihtml/affiliate_bulletin.html */ ?>
<?php echo '
<script>
																				...
																				<td width="847" align="left" valign="top"
																					...
																					<table width="100%" border="0" cellspacing="0"
																						...
																						<tr>
																							...
																							<a href="index.php?stage=affiliates&mode=BulletinsDetail&id=<?php echo $this->_tpl_vars['affiliateVoteAlert'][$this->_sections['i']['index']]['article_id']; ?>
"
																						...
																						<a class="arial12Ba60000" href="index.php?stage=affiliates&mode=NewsEdit&id=<?php echo $this->_tpl_vars['affiliateVoteAlert'][$this->_sections['i']['index']]['article_id']; ?>
																	...
																	<td align="left" valign="top"
																		...
																		<table width="100%">
																			<tr>
																				<td valign="top"
																					class="bg_f7f6ee"
																					align="center">There are no bulletins.</td>
																			</tr>
																		</table></td>
																</tr>
																<?php endif; ?>																
															<?php else: ?>															
																<tr>
																	<td height="40" align="center" valign="middle" class="bg_f7f6ee">
																		Not authorized to view bulletins.	
																	</td>
																</tr>
															<?php endif; ?>
