	...
	/*
		...
		*/
		function ListSubscriber()
		{
			...
			$oGrid = new Grid();
			$oGrid->sTitle 			=	"Subscriber List";
			$oGrid->sDescription 	= 	"List of all Subscriber";
			...
			//$this->obTemplate->assign('CustomForm', $this->obTemplate->fetch("employer/ihtml/search_fields.html"));
